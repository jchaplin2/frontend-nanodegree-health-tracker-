(function($){
  ...
  self : this,
    ...
    self.clearResults();
        var e = $("#search-val").val(), a = "https://api.nutritionix.com/v1_1/search/" + e + "?results=0:20&fields=item_name,brand_name,item_id,nf_calories&appId=323fe4ef&appKey=9b8af06a3904049cbd7fea787d4088a6";
        $.ajax({
            method: "GET",
            url: a,
            dataType: "json",
